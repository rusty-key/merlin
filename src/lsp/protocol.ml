...
let documentUri_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.documentUri" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> documentUri_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                               ->
                                                               documentUri
...
let zero_based_int_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.zero_based_int" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> zero_based_int_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                                  ->
                                                                  zero_based_int
                                                                    Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = zero_based_int_of_yojson'
...
let position_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.position" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> position_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                            ->
                                                            position
                                                              Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = position_of_yojson'
...
let range_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.range" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> range_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                         ->
                                                         range
                                                           Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = range_of_yojson'
...
let rec params_of_yojson =
  (let _tp_loc = "src/lsp/protocol.ml.DidOpen.params" in
   fun t -> didOpenTextDocumentParams_of_yojson t : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                      -> params)
and params_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.DidOpen.params" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> params_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                          ->
                                                          params
                                                            Ppx_yojson_conv_lib.Yojson_conv.Result.t)
...
and didOpenTextDocumentParams_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.DidOpen.didOpenTextDocumentParams" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> didOpenTextDocumentParams_of_yojson yojson) yojson :
  Ppx_yojson_conv_lib.Yojson.Safe.t ->
    didOpenTextDocumentParams Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = params_of_yojson
and _ = params_of_yojson'
...
and didChangeTextDocumentParams_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.DidChange.didChangeTextDocumentParams" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> didChangeTextDocumentParams_of_yojson yojson) yojson :
  Ppx_yojson_conv_lib.Yojson.Safe.t ->
    didChangeTextDocumentParams Ppx_yojson_conv_lib.Yojson_conv.Result.t)
...
and textDocumentContentChangeEvent_of_yojson' =
  (let _tp_loc =
   ...
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> textDocumentContentChangeEvent_of_yojson yojson) yojson :
  Ppx_yojson_conv_lib.Yojson.Safe.t ->
    textDocumentContentChangeEvent Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = params_of_yojson
and _ = params_of_yojson'
...
and publishDiagnosticsParams_of_yojson' =
  (let _tp_loc =
   ...
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> publishDiagnosticsParams_of_yojson yojson) yojson :
  Ppx_yojson_conv_lib.Yojson.Safe.t ->
    publishDiagnosticsParams Ppx_yojson_conv_lib.Yojson_conv.Result.t)
...
and diagnostic_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.PublishDiagnostics.diagnostic" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> diagnostic_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                              ->
                                                              diagnostic
                                                                Ppx_yojson_conv_lib.Yojson_conv.Result.t)
...
and diagnosticRelatedInformation_of_yojson' =
  (let _tp_loc =
   ...
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> diagnosticRelatedInformation_of_yojson yojson) yojson :
  Ppx_yojson_conv_lib.Yojson.Safe.t ->
    diagnosticRelatedInformation Ppx_yojson_conv_lib.Yojson_conv.Result.t)
...
and relatedLocation_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.PublishDiagnostics.relatedLocation" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> relatedLocation_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                                   ->
                                                                   relatedLocation
                                                                    Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = params_of_yojson
...
module Completion = struct
  ...
  (** Once we get better PPX support we can use [@@deriving_inline enum].[@@@end]
...
and completionParams_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Completion.completionParams" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> completionParams_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                                    ->
                                                                    completionParams
                                                                    Ppx_yojson_conv_lib.Yojson_conv.Result.t)
...
and completionContext_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Completion.completionContext" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> completionContext_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                                    ->
                                                                    completionContext
                                                                    Ppx_yojson_conv_lib.Yojson_conv.Result.t)
...
and result_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Completion.result" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> result_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                          ->
                                                          result
                                                            Ppx_yojson_conv_lib.Yojson_conv.Result.t)
...
and completionList_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Completion.completionList" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> completionList_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                                  ->
                                                                  completionList
                                                                    Ppx_yojson_conv_lib.Yojson_conv.Result.t)
...
and completionItem_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Completion.completionItem" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> completionItem_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                                  ->
                                                                  completionItem
                                                                    Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = params_of_yojson
...
and hoverResult_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Hover.hoverResult" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> hoverResult_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                               ->
                                                               hoverResult
                                                                 Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = params_of_yojson
...
let synchronization_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Initialize.synchronization" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> synchronization_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                                   ->
                                                                   synchronization
                                                                    Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = synchronization_of_yojson'
...
let completion_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Initialize.completion" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> completion_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                              ->
                                                              completion
                                                                Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = completion_of_yojson'
...
let hover_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Initialize.hover" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> hover_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                         ->
                                                         hover
                                                           Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = hover_of_yojson'
...
let documentSymbol_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Initialize.documentSymbol" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> documentSymbol_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                                  ->
                                                                  documentSymbol
                                                                    Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = documentSymbol_of_yojson'
...
let textDocumentClientCapabilities_of_yojson' =
  (let _tp_loc =
   ...
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> textDocumentClientCapabilities_of_yojson yojson) yojson :
  Ppx_yojson_conv_lib.Yojson.Safe.t ->
    textDocumentClientCapabilities Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = textDocumentClientCapabilities_of_yojson'
...
let workspaceEdit_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Initialize.workspaceEdit" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> workspaceEdit_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                                 ->
                                                                 workspaceEdit
                                                                   Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = workspaceEdit_of_yojson'
...
let workspaceClientCapabilities_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Initialize.workspaceClientCapabilities" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> workspaceClientCapabilities_of_yojson yojson) yojson :
  Ppx_yojson_conv_lib.Yojson.Safe.t ->
    workspaceClientCapabilities Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = workspaceClientCapabilities_of_yojson'
...
let windowClientCapabilities_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Initialize.windowClientCapabilities" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> windowClientCapabilities_of_yojson yojson) yojson :
  Ppx_yojson_conv_lib.Yojson.Safe.t ->
    windowClientCapabilities Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = windowClientCapabilities_of_yojson'
...
let telemetryClientCapabilities_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Initialize.telemetryClientCapabilities" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> telemetryClientCapabilities_of_yojson yojson) yojson :
  Ppx_yojson_conv_lib.Yojson.Safe.t ->
    telemetryClientCapabilities Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = telemetryClientCapabilities_of_yojson'
...
let client_capabilities_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Initialize.client_capabilities" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> client_capabilities_of_yojson yojson) yojson :
  Ppx_yojson_conv_lib.Yojson.Safe.t ->
    client_capabilities Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = client_capabilities_of_yojson'
...
and errorData_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Initialize.errorData" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> errorData_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                             ->
                                                             errorData
                                                               Ppx_yojson_conv_lib.Yojson_conv.Result.t)
...
and server_capabilities_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Initialize.server_capabilities" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> server_capabilities_of_yojson yojson) yojson :
  Ppx_yojson_conv_lib.Yojson.Safe.t ->
    server_capabilities Ppx_yojson_conv_lib.Yojson_conv.Result.t)
...
and completionOptions_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Initialize.completionOptions" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> completionOptions_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                                    ->
                                                                    completionOptions
                                                                    Ppx_yojson_conv_lib.Yojson_conv.Result.t)
...
and codeLensOptions_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Initialize.codeLensOptions" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> codeLensOptions_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                                   ->
                                                                   codeLensOptions
                                                                    Ppx_yojson_conv_lib.Yojson_conv.Result.t)
...
and documentOnTypeFormattingOptions_of_yojson' =
  (let _tp_loc =
   ...
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> documentOnTypeFormattingOptions_of_yojson yojson)
       yojson : Ppx_yojson_conv_lib.Yojson.Safe.t ->
                  documentOnTypeFormattingOptions
                    Ppx_yojson_conv_lib.Yojson_conv.Result.t)
...
and documentLinkOptions_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Initialize.documentLinkOptions" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> documentLinkOptions_of_yojson yojson) yojson :
  Ppx_yojson_conv_lib.Yojson.Safe.t ->
    documentLinkOptions Ppx_yojson_conv_lib.Yojson_conv.Result.t)
...
and executeCommandOptions_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Initialize.executeCommandOptions" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> executeCommandOptions_of_yojson yojson) yojson :
  Ppx_yojson_conv_lib.Yojson.Safe.t ->
    executeCommandOptions Ppx_yojson_conv_lib.Yojson_conv.Result.t)
...
and textDocumentSyncOptions_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Initialize.textDocumentSyncOptions" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> textDocumentSyncOptions_of_yojson yojson) yojson :
  Ppx_yojson_conv_lib.Yojson.Safe.t ->
    textDocumentSyncOptions Ppx_yojson_conv_lib.Yojson_conv.Result.t)
...
and saveOptions_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.Initialize.saveOptions" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> saveOptions_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                               ->
                                                               saveOptions
                                                                 Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = params_of_yojson
...
and referenceContext_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.References.referenceContext" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> referenceContext_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                                    ->
                                                                    referenceContext
                                                                    Ppx_yojson_conv_lib.Yojson_conv.Result.t)
and result_of_yojson =
...
and item_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.CodeLens.item" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> item_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                        ->
                                                        item
                                                          Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = params_of_yojson
...
let _ = params_of_yojson
let params_of_yojson' =
  (let _tp_loc = "src/lsp/protocol.ml.DebugTextDocumentGet.params" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> params_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                          ->
