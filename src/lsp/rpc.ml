...
let response_of_yojson' =
  (let _tp_loc = "src/lsp/rpc.ml.Response.response" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> response_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                            ->
                                                            response
                                                              Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = response_of_yojson'
...
and response_error_of_yojson' =
  (let _tp_loc = "src/lsp/rpc.ml.Response.response_error" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> response_error_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                                  ->
                                                                  response_error
                                                                    Ppx_yojson_conv_lib.Yojson_conv.Result.t)
and error_of_yojson =
...
and error_of_yojson' =
  (let _tp_loc = "src/lsp/rpc.ml.Response.error" in
   fun yojson ->
     Ppx_yojson_conv_lib.Yojson_conv.Result.pack
       (fun yojson -> error_of_yojson yojson) yojson : Ppx_yojson_conv_lib.Yojson.Safe.t
                                                         ->
                                                         error
                                                           Ppx_yojson_conv_lib.Yojson_conv.Result.t)
let _ = response_error_of_yojson
and _ = response_error_of_yojson'
